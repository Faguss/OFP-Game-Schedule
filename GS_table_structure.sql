...
(25, 'main', 33, 0, 0, 22, '{{GS_STR_MENU_INSTALLSCRIPTS}}', 'install_scripts', 'fa fa-fw fa-book'),
(26, 'main', 33, 0, 0, 20, '{{GS_STR_MENU_QUICKSTART}}', 'quickstart', 'fa fa-fw fa-life-ring'),
(36, 'main', 33, 0, 0, 31, '{{GS_STR_MENU_BIFORUM}}', 'https://forums.bohemia.net/forums/topic/202547-game-schedule-with-fwatch/', 'fa fa-fw fa-comments'),
(34, 'main', 33, 0, 0, 32, '{{GS_STR_MENU_STEAMFORUM}}', 'https://steamcommunity.com/app/65790/discussions/0/135510393205713439/', 'fa fa-fw fa-comments'),
...
(15, 'main', 33, 0, 1, 38, '{{hr}}', '', ''),
(16, 'main', 33, 0, 1, 110, '{{MENU_LOGOUT}}', 'users/logout.php', 'fa fa-fw fa-sign-out'),
(27, 'main', 33, 0, 0, 30, '{{GS_STR_MENU_VIDEOS}}', 'https://www.youtube.com/playlist?list=PLdz-dynlxN35fbZaUti68fBqqvN0KLm7Y', 'fa fa-fw fa-youtube-play'),
(20, 'main', -1, 0, 1, 12, '{{notifications}}', '', ''),
(21, 'main', -1, 0, 1, 13, '{{messages}}', '', ''),
(33, 'main', -1, 1, 0, 20, '{{SCHEDULE_MENU}}', '#', 'fa fa-fw fa-bars'),
(44, 'main', 33, 0, 0, 26, '{{hr}}', '#', ''),
(39, 'main', -1, 0, 0, 99999, '{{SIGNIN_BUTTONTEXT}}', 'users\\login.php', 'fa fa-fw fa-sign-in'),
(61, 'main', 33, 0, 0, 37, '{{GS_STR_MENU_CONTACT}}', 'http://ofp-faguss.com/about', 'fa fa-fw fa-envelope'),
(46, 'main', 33, 0, 0, 23, '{{GS_STR_MENU_DEDICATED}}', 'dedicated_server', 'fa fa-fw fa-book'),
(48, 'main', 33, 0, 0, 24, 'API', 'api_documentation', 'fa fa-fw fa-book'),
(49, 'main', 33, 0, 0, 36, '{{SCHEDULE_SOURCE_CODE}}', 'https://github.com/Faguss/OFP-Game-Schedule', 'fa fa-fw fa-github'),
(50, 'main', 33, 0, 0, 33, '{{GS_STR_MENU_GOGFORUM}}', 'https://www.gog.com/forum/arma_series/arma_cwa_with_fwatch_116', 'fa fa-fw fa-comments'),
(51, 'main', 33, 0, 0, 21, '{{GS_STR_MENU_MODUPDATES}}', 'mod_updates', 'fa fa-fw fa-book'),
(52, 'main', 33, 0, 1, 25, '{{GS_STR_MENU_TRANSLATION}}', 'translation.php', 'fa fa-fw fa-language'),
(53, 'main', -1, 1, 0, 19, '{{GS_STR_LANGUAGE}}', '#', 'fa fa-fw fa-globe'),
(54, 'main', 53, 0, 0, 300, '{{GS_STR_ENGLISH}}', '#langEN', ''),
(55, 'main', 53, 0, 0, 301, '{{GS_STR_POLISH}}', '#langPL', ''),
(56, 'main', 53, 0, 0, 302, '{{GS_STR_RUSSIAN}}', '#langRU', ''),
(57, 'main', 33, 0, 0, 1, '{{GS_STR_INDEX_SCHEDULE}}', 'allservers', 'fa fa-fw fa-calendar'),
(58, 'main', 33, 0, 0, 2, '{{GS_STR_INDEX_MODS}}', 'allmods', 'fa fa-fw fa-cubes'),
(59, 'main', 33, 0, 0, 3, '{{GS_STR_INDEX_RECENT}}', 'recent_activity', 'fa fa-fw fa-feed'),
(60, 'main', 33, 0, 0, 4, '{{hr}}', '', '');
...
--
-- Host: localhost
-- Generation Time: Oct 23, 2023 at 11:32 PM
