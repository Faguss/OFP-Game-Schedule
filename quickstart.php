...
if ($lang["THIS_CODE"] == "en-US") {
	...
	"GS_STR_QUICKSTART_FWATCH_MOD_MANAGER" => "Mod Manager",
...
if ($lang["THIS_CODE"] == "ru-RU") {
	...
	"GS_STR_QUICKSTART_FWATCH_MOD_MANAGER" => "Менеджер модов",
...
if ($lang["THIS_CODE"] == "pl-PL") {
	...
	"GS_STR_QUICKSTART_FWATCH_MOD_MANAGER" => "Menedżer Modów",
...
<ul id="quickstart_tabs" class="nav nav-tabs" role="tablist">
	...
	<li><a href="../fwatch/modmanager/details">'.lang("GS_STR_QUICKSTART_FWATCH_MOD_MANAGER").'</a></li>
</ul>
<div class="jumbotron">
