...
<h2>Cookies Policy of <span class="website_url">www.ofp-faguss.com/schedule/</span></h2>

<p>This website, <span class="website_url">www.ofp-faguss.com/schedule/</span> (the "Website"), is operated by <span class="website_name">Faguss' Website</span>.</p>

<h3>What are cookies?</h3>

<p>Cookies are a small text files that are stored in your web browser that allows <span class="website_name">Faguss' Website</span> or a third party to recognize you. Cookies can be used to collect, store and share bits of information about your activities across websites, including on <span class="website_name">Faguss' Website</span>.</p>
...
<p><span class="website_name">Faguss' Website</span> uses both session cookies and persistent cookies.</p>
...
<h3>How do third parties use cookies on the <span class="website_name">Faguss' Website</span>?</h3>

<p>Third party companies like analytics companies and ad networks generally use cookies to collect user information on an anonymous basis. They may use that information to build a profile of your activities on the <span class="website_name">Faguss' Website</span> and other websites that you've visited.</p>
...
<li><a href="http://cookies.insites.com/">Cookies & You</a></li>
</ul>
