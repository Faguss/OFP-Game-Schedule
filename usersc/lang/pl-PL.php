...
$lang = array_merge($lang,array(
	...
	"GS_STR_MOD_SUBTITLE" => "Druga Nazwa",
	"GS_STR_MOD_SUBTITLE_HINT" => "Jest już mod z taką samą nazwą folderu. Dodaj drugą, krótką nazwę (10 znaków), żeby go odróżnić",
	"GS_STR_MOD_DESCRIPTION" => "Opis",
	"GS_STR_MOD_DESCRIPTION_HINT" => "Kto jest autorem i co dodaje ten mod?",
	"GS_STR_MOD_DESCRIPTION_EXAMPLE" => "Now modele jednostek i animacje autorstwa Sanctuariego",
	"GS_STR_MOD_ACCESS" => "Hasło",
	"GS_STR_MOD_ACCESS_HINT" => "Wpisanie hasła spowoduje zniknięcie moda z publicznej listy",
	"GS_STR_MOD_PUBLIC" => "Publiczny",
	"GS_STR_MOD_PRIVATE" => "Prywatny",
	"GS_STR_MOD_FORCENAME" => "Wymuś Nazwę",
	"GS_STR_MOD_FORCENAME_HINT" => "Niektóre mody używają bezwzględnych ścieżek w swoich skryptach (na przykład: ..\@ECP\ECP_Settings.sqf) i ich nazwy nie powinny być zmieniane. Zaznaczenie tej opcji spowoduje, że Fwatch będzie wymuszał oryginalną nazwę folderu przy włączaniu moda",
	...
	"GS_STR_MOD_ALIAS_DESC" => "Jeśli zmienisz nazwę modu to wpisz starszą nazwę tutaj, żeby nie trzeba było zmienić nazwy folderu w paczce do ściągnięcia. Patrz %m1%Alias%m2%",
