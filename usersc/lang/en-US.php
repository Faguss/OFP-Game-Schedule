...
$lang = array_merge($lang,array(
	...
	"GS_STR_MOD_SUBTITLE" => "Second Name",
	"GS_STR_MOD_SUBTITLE_HINT" => "There is already a mod with the same folder name. Add a short second name (10 characters) to distinguish it from the other",
	"GS_STR_MOD_DESCRIPTION" => "Description",
	"GS_STR_MOD_DESCRIPTION_HINT" => "Who made it and what does it add to the game?",
	"GS_STR_MOD_DESCRIPTION_EXAMPLE" => "New infantry models and animations by Sanctuary",
	"GS_STR_MOD_ACCESS" => "Password",
	"GS_STR_MOD_ACCESS_HINT" => "Adding a password will hide this mod from the public list",
	"GS_STR_MOD_PUBLIC" => "Public",
	"GS_STR_MOD_PRIVATE" => "Private",
	"GS_STR_MOD_FORCENAME" => "Force Folder Name",
	"GS_STR_MOD_FORCENAME_HINT" => "Some mods use absolute paths in their scripts (like ..\@ECP\ECP_Settings.sqf) so they shouldn't be renamed. Enabling this option will make Fwatch enforce original folder name on launch",
	...
	"GS_STR_MOD_ALIAS_DESC" => "If you rename your mod then write here old name so that you don't have to rename the folder in the download archive. See %m1%Alias%m2%",
