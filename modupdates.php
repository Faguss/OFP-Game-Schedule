...
if ($lang["THIS_CODE"] == "en-US") {
	$lang = array_merge($lang, array(
		...
		"GS_MU_SECTION1_PAR7" => "Clicking on the option starts the update process. Website combines installation scripts based on what the user is missing. Scripts that are repeated (option #1) are ignored so that user will get the archive only once (see example below).",
